...
public class AssetsController {
	...
	@RequestMapping("/list")
	public ModelAndView list(Integer goPage, @ModelAttribute(value="assetsName") String assetsName, @ModelAttribute(value="assetsNumber") String assetsNumber ,@ModelAttribute(value="location") String location){
