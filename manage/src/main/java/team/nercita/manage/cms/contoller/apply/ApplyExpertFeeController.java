...
public class ApplyExpertFeeController {
	...
	public ModelAndView toadd(){
		ModelAndView view = new ModelAndView("apply/online/expertFee/add");
		return view;
	}
	...
	public String add(ApplyExpertFee applyExpertFee, RedirectAttributes attr){
		...
		expertFeeService.doTransSaveApplyExpertFee1(applyExpertFee, user);
	...
	public String edit(ApplyExpertFee applyExpertFee, RedirectAttributes attr){
		...
		expertFeeService.doTransUpdateApplyExpertFee2(applyExpertFee, user);
