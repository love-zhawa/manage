...
public interface PurchaseService {
	...
	public void doTransUpdatePurchaseDetail(String id, int amount);//入库管理的修改
	public void doTransSavePurchaseDetail(PurchaseDetail detail);//入库管理添加（借用）
	
	public void doTransUpdatePurchaseDetails(PurchaseDetail detail);//入库管理的修改（借用）
	
	public void doTransIncomeDel(String id);//删除
}
