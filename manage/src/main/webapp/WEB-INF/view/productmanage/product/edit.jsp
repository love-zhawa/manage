  ...
  <div class="body-content">
    <form action="product/edit" method="post" class="form-x" id="form-article-add" >
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="taskDate" name="taskDate" autocomplete="off" value="<fmt:formatDate value="${productRecord.taskDate }" pattern="yyyy-MM-dd"/>"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="endDate" id="endDate" autocomplete="off" value="<fmt:formatDate value="${productRecord.endDate }" pattern="yyyy-MM-dd"/>"/>
        </div>
      </div>
