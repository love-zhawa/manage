  ...
  <div class="body-content">
    <form action="jxc/purchase/editapply" method="post" class="form-x" id="form-article-add" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="applyTime" name="applyTime" autocomplete="off" value="<fmt:formatDate value="${apply.applyTime }" pattern="yyyy-MM-dd"/>"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="endTime" name="endTime" autocomplete="off" value="<fmt:formatDate value="${apply.endTime }" pattern="yyyy-MM-dd"/>"/>
        </div>
      </div>
	  <div class="form-group">
        <div class="label">
