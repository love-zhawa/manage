    ...
    <form action="jxc/store/addstore" method="post" class="form-x" id="form-article-add" enctype="multipart/form-data">
      ...
      <c:if test="${userid ne '9277827d7eda400cb5a71ee51ed1d766' }">
      	<div class="form-group">
	        ...
	        <div class="field">
	          <input type="text" class="input" id="brand" name="brand" readonly/>
	        </div>
	      </div>
	      ...
	      <div class="form-group">
	        ...
	        <div class="field">
	          <select name="productDealer.id"  class='input' disabled="disabled">
	          	<option value="">请选择</option>
	          	<c:forEach items="${dealerList }" var="dealer">
	          		<option value="${dealer.id }">${dealer.dealerName }</option>
	          	</c:forEach>
	      ...
	      <div class="form-group">
	        ...
	        <div class="field">
	          <input type="text" class="input" id="prize" name="prize" readonly/>
	        </div>
	      </div>
      </c:if>
      <div class="form-group">
