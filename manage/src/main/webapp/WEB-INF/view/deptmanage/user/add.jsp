  ...
  <div class="body-content">
    <form action="user/add" method="post" class="form-x" id="form-article-add" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="bank" value=""/>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="inductionTime" name="inductionTime" value="" autocomplete="off"/>
      ...
      <div class="form-group" >
        ...
        <div class="field">
          <input type="text" class="input" id="departureTime" name="departureTime" value="" autocomplete="off"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="entranceTime" id="entranceTime" value="" autocomplete="off"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
        	<input type="text" class="input" id="graduationTime" name="graduationTime" value="" autocomplete="off"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input name="tutor" class="input" maxlength="10" autocomplete="off"></input>
        </div>
      </div>
