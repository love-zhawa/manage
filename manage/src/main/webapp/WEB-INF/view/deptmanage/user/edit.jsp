  ...
  <div class="body-content">
    <form action="user/edit" method="post" class="form-x" id="form-article-add" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="bank" value="${user.bank }"/>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input" name="cardid" value="${user.cardid }"/>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="inductionTime" name="inductionTime" value="${user.inductionTime }" autocomplete="off"/>
      ...
      <div class="form-group" >
        ...
        <div class="field">
          <input type="text" class="input" id="departureTime" name="departureTime" value="${user.departureTime }" autocomplete="off"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <select name="education" class="input w50"  style="width: 300px;">
			<option value="1" <c:if test="${user.education == 1 }">selected</c:if>>硕士</option>
			<option value="2" <c:if test="${user.education == 2 }">selected</c:if>>博士</option>
			<option value="3" <c:if test="${user.education == 3 }">selected</c:if>>学士</option>
		</select>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="entranceTime" id="entranceTime" value="${user.entranceTime }" autocomplete="off"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
        	<input type="text" class="input" id="graduationTime" name="graduationTime" value="${user.graduationTime }" autocomplete="off"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input name="tutor" class="input" value="${user.tutor }" maxlength="10" autocomplete="off"></input>
        </div>
      </div>
