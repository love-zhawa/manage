...
<form action="funds/reimbursement/list" method="post" id="searchForm">
  <div class="panel admin-panel">
     ...
     <tr>
      ...
      <td class="td-manage">
      	<div class="button-group">
       		...
       		<c:if test="${record.status == 1 && (roleid == '2df370f1f420497bbd5a1b5ef8d3a6ee' || roleid=='96e79218965eb72c92a549dd5a330112')}">
       			<shiro:hasPermission name="funds_reimbursement_edit">
		       		<a class="button border-main" onclick="toedit('${record.id}')" href="javascript:;">
		       			<span class="icon-edit"></span> 编辑
		       		</a>
	...
	<script type="text/javascript">
		...
		function todel(id) {
			if(confirm("确认删除？")){
				$.post("funds/reimbursement/del",{"id":id},function(data){
					if(data == 0) {
						alert("删除成功！");
					} else {
						alert("删除失败！");
