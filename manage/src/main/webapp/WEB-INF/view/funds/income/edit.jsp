...
<div class="panel admin-panel">
  ...
  <div class="body-content">
	...
	<input type="hidden" name="status" value="${fundsIncome.status }"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" id="changeTime" name="changeTime" autocomplete="off" value="<fmt:formatDate value="${fundsIncome.changeTime }" pattern="yyyy-MM-dd"/>"/>
        </div>
      </div>
