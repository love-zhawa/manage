...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form action="funds/transfer/edit" method="post" class="form-x" id="form-article-add" >
    	...
    	<input type="hidden" name="auditStatus" value="${transfer.auditStatus }"/>
      <div class="form-group">
        <div class="label">
          <label>申请时间：</label>
        </div>
        <div class="field">
          <input type="text" class="input" id="transDate" name="transDate" autocomplete="off" value="<fmt:formatDate value="${transfer.transDate }" pattern="yyyy-MM-dd"/>"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <select class="input" name="project.id" style="width: 300px;" onchange="projectChange()">
