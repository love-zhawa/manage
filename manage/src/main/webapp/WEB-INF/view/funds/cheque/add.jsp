...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;创建支票领用登记单</strong></div>
          ...
          <table class="table table-hover text-center">
		     ...
		     <tbody id="items">
					<tr id="item0">
						...
						<td> <div class="field" id="financialNumber0"></div>
						<input type="hidden" class="input" id="totalMoney0"/>
						<input type="hidden" class="input" id="financialNumber0"/><!-- <input type="text" class="input" name="detailList[0].number"> --></td>
						<td><input type="text" class="input" name="detailList[0].detail"></td>
						<td><input type="text" class="input" name="detailList[0].amount" id="amount0"></td>
