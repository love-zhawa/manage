...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;创建外拨经费</strong></div>
  <div class="body-content">
    <form action="funds/out/add" method="post" class="form-x" id="form-article-add" >
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="outTime" id="outTime" value="" autocomplete="off"/>
        </div>
      </div>
