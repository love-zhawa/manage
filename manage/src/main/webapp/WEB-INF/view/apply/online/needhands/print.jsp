...
<html>
	...
	<body>
        ...
        <tr>
          <th>聘用方式</th>
          <td colspan="6">
          	<span style="display:block; width: 110px; float:left;text-align: left;margin-left: 15px;">事业(<span style="display: inline-block;width: 20px;text-align: center;"><c:if test="${needhands.employType == 1}">√</c:if></span>) </span>
          	<span style="display:block; width: 130px; float:left;text-align: left;margin-left: 15px;">企业(<span style="display: inline-block;width: 20px;text-align: center;"><c:if test="${needhands.employType == 2}">√</c:if></span>)(派得/农芯)</span>
          	<span style="display:block; width: 110px; float:left;text-align: left;margin-left: 15px;">合同(<span style="display: inline-block;width: 20px;text-align: center;"><c:if test="${needhands.employType == 3}">√</c:if></span>) </span>
          	<span style="display:block; width: 110px; float:left;text-align: left;margin-left: 15px;">博士后(<span style="display: inline-block;width: 20px;text-align: center;"><c:if test="${needhands.employType == 4}">√</c:if></span>) </span>
          </td>
        </tr>
        <tr>
          <th>拟聘人姓名</th>
