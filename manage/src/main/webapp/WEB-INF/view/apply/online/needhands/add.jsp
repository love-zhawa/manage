...
<body>
		...
		<form action="apply/online/needhands/add" method="post" class="form-x" id="form-article-add" >
			...
			<tr>
	          <th width="90">用人部门</th>
	          <td colspan="4"><input type="text" class="input" name="dept" /></td>
	          <th width="110">申请日期</th>
	          <td><input type="text" class="input" id="applyDate" name="applyDate" value="" autocomplete="off"/></td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	          <th>拟聘人姓名</th>
	          <td colspan="2"><input type="text" class="input" name="userName" /></td>
	          <th width="45">性别</th>
	          <td width="90">
	          ...
	          <th>年龄</th>
	          <td><input type="text" class="input" id="age" name="age"/></td>
	        </tr>
	        <tr>
	          <th>拟聘人学历</th>
	          <td colspan="2" width="90"><input type="text" class="input" id="education" name="education"  /></td>
	          <th width="90">入职日期</th>
	          <td colspan="3"><input type="text" class="input" id="joinDate" name="joinDate" autocomplete="off"/></td>
	        </tr>
	        <tr>
	           <th>合同期限</th>
	           <td colspan="2"><input type="text" class="input" id="termAmount" name="termAmount"  /></td>
	           <th>试用期期限</th>
	          <td colspan="3"><input type="text" class="input" id="trialAmount" name="trialAmount"  /></td>
	        </tr>
	        <tr>
	          <th>岗位津贴</th>
	          <td colspan="2"><input type="text" class="input" id="amount" name="amount"  /></td>
	          <th>试用期岗位津贴</th>
	          <td colspan="3"><input type="text" class="input" id="trialAmountSubsidy" name="trialAmountSubsidy"  /></td>
	        </tr>
	      </table>
	        <div class="field">
