...
<body>
	<h1 class="title">信息中心学生返校申请表</h1>
		...
		<input type="hidden" name="id" value="${backToSchool.id }"/>
	        ...
	        <tr>
	          <th>就读学校</th>
	          <td><input type="text" class="input" id="school" name="school" value="${backToSchool.school }"/></td>
	          <th>入学时间</th>
	          <td><input type="text" class="input" id="entranceTime" name="entranceTime" value="${backToSchool.entranceTime }" autocomplete="off"/></td>
	        </tr>
	        <tr>
	          <th>入中心时间</th>
	          <td><input type="text" class="input" id="centerTime" name="centerTime" value="${backToSchool.centerTime }" autocomplete="off"/></td>
	          <th>培养方式</th>
	          <td><input type="text" class="input" id="cultivationMode" name="cultivationMode"  value="${backToSchool.cultivationMode }"/></td>
	        </tr>
	        <tr>
	          <th>导师姓名</th>
	          <td><input type="text" class="input" id="tutor" name="tutor" value="${backToSchool.tutor }"  autocomplete="off"/></td>
	          <th>拟离开中心时间</th>
	          <td><input type="text" class="input" id="leaveTime" name="leaveTime" value="${backToSchool.leaveTime }" autocomplete="off"/></td>
	        </tr>
	        <tr>
	          <th>原由</th>
	          <td colspan="3"><input type="text" class="input" id="reason" name="reason"  value="${backToSchool.reason }"/></td>
	        </tr>
	      </table>
	      <div class="field">
