...
<body>
	<h1 class="title">人事变动表</h1>
	  <form action="apply/online/changeDept/add" method="post" class="form-x" id="form-article-add" >
        ...
        <tr>
          <th>变动前部门</th>
          <td><input type="text" class="input" name="beforeDept" /></td>
          <th>变动后部门</th>
          <td><input type="text" class="input" name="afterDept" /></td>
        </tr>
        <tr>
          <th>类别</th>
          <td colspan="3" style="height:40px;padding-top:14px;">
 			<label><input name="changeType" type="radio" checked="checked" class="ace" value="1"><span class="lbl">调岗</span></label>&nbsp;&nbsp;
        ...
        <tr>
          <th>截止期限</th>
          <td><input type="text" class="input" id="changeEndTime" name="changeEndTime" autocomplete="off"/></td>
          <th>其他</th>
          <td><input type="text" class="input" name="otherInfo"  /></td>
        </tr>
        <tr>
          <th>变动前津贴</th>
          <td><input type="text" class="input" id="beforeAmount" name="beforeAmount"/></td>
          <th>变动后津贴</th>
          <td><input type="text" class="input" id="afterAmount" name="afterAmount"  /></td>
        </tr>
        <tr>
          <th>执行日期</th>
          <td><input type="text" class="input" id="changeTime" name="changeTime" autocomplete="off"/></td>
          <th>填报时间</th>
          <td><input type="text" class="input" id="applyTime" name="applyTime" autocomplete="off"/></td>
        </tr>
      </table>
      <div class="field">
