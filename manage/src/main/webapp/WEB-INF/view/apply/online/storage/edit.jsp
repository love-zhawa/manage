...
<h1 class="title">办公室出入库登记</h1>
	<form action="apply/online/storage/edit" method="post" class="form-x" id="form-article-add" >
	<input type="hidden" name="id" value="${storage.id }"/>
		...
		<tr height="50">
          ...
          <td style="padding-top:16px;"><input type="text" class="input" id="titleName" name="titleName" value="${storage.titleName }"/></td>
          <th>出入库日期</th>
          <td><input type="text" class="input" name="changeTime" id="changeTime" value="${storage.changeTime }" autocomplete="off"/></td>
        </tr>
        <tr height="50">
          <th>送货部门</th>
          <td><input type="text" class="input" name="dept" id="dept" value="${storage.dept }"/></td>
          <th>库单编号</th>
          <td><input type="text" class="input" name="kdNumber" value="${storage.kdNumber }"/></td>
        </tr>
        <tr height="50">
          <th>库单</th>
          <td colspan="3">
