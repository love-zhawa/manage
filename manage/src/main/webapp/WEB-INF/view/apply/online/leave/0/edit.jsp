...
<body>
	...
	<form action="apply/online/leave/edit" method="post" class="form-x" id="form-article-add" >
	 ...
	 <input name="id" value="${leave.id }" type="hidden"/>
        ...
        <tr height="50">
          <th>申请时间</th>
          <td><input type="text" class="input" id="applyTime" name="applyTime" value="${leave.applyTime }" autocomplete="off"/></td>
          <th>联系电话</th>
          <td><input type="text" class="input" name="phoneNumber" value="${leave.phoneNumber }"/></td>
        </tr>
        <tr height="50">
          <th>请假类别</th>
        ...
        <tr height="50">
          <th>事由</th>
          <td colspan="3"><input type="text" class="input" name="reason" value="${leave.reason }"/></td>
        </tr>
        <tr height="50">
          <th>紧急联系人</th>
          <td><input type="text" class="input" name="contactUser" value="${leave.contactUser }"/></td>
          <th>紧急联系人电话</th>
          <td><input type="text" class="input" id="contactMobile" name="contactMobile" value="${leave.contactMobile }"/></td>
        </tr>
        <tr>
          <th>开始时间</th>
          <td><input type="text" class="input" id="beginTime" name="beginTime" autocomplete="off" value="<fmt:formatDate value="${leave.beginTime }" pattern="yyyy-MM-dd HH:mm:ss"/>"/></td>
          <th>结束时间</th>
          <td><input type="text" class="input" id="endTime" name="endTime" autocomplete="off" value="<fmt:formatDate value="${leave.endTime }" pattern="yyyy-MM-dd HH:mm:ss"/>"/></td>
          </th>
        </tr>
      </table>
      <div class="field">
	...
	function back (){
		window.location.href="apply/online/leave/list";
	}
	</script>
