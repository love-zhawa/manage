          		...
          		<c:choose>
		         	<c:when test="${changeDept.changeType == 2}">（截止期限：
		         		<span style="display: inline-block;width: 35px;">
		         			<fmt:formatDate value="${changeDept.changeEndTime }" pattern="yyyy"/>
		         		</span>年
		         		<span style="display: inline-block;width: 20px;">
		         			<fmt:formatDate value="${changeDept.changeEndTime }" pattern="MM"/>
		         		</span>月
		         		<span style="display: inline-block;width: 20px;">
		         			<fmt:formatDate value="${changeDept.changeEndTime }" pattern="dd"/>
		         		</span>日）
		         	</c:when>
