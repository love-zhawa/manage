...
<body>
		...
		<form action="apply/online/register/add" method="post" class="form-x" id="form-article-add" >
			...
			<tr>
	          <th width="67">姓名</th>
	          <td width="95"><input type="text" class="input" id="userName" name="userName" value=""/></td>
	          <th width="42">性别</th>
	          <td width="90">
	          	<label><input name="gender" type="radio" checked="checked" class="ace" value="0"><span class="lbl">男</span></label>&nbsp;&nbsp;
          		<label><input name="gender" type="radio" class="ace" value="1"><span class="lbl">女</span></label></td>
	          <th width="40">民族</th>
	          <td width="60"><input type="text" class="input" name="nation" /></td>
	          <th width="60">籍贯</th>
	          <td width="216"><input type="text" class="input" name="place"/></td>
	        </tr>
	        <tr>
	          <th>学历</th>
	          <td><input type="text" class="input" name="education" /></td>
	          ...
	          <td><input type="text" class="input" id="birth" name="birth" autocomplete="off"/></td>
	        </tr>
	        <tr>
	          <th>E-mail</th>
	          <td colspan="4"><input type="text" class="input" name="email" /></td>
	          <th colspan="2">联系电话（手机）</th>
	          <td><input type="text" class="input" name="phone" /></td>
	        </tr>
	        <tr>
	          <th>专业</th>
	          <td colspan="4"><input type="text" class="input" name="major" /></td>
	          <th colspan="2">入学时间</th>
	          <td><input type="text" class="input" id="entranceTime" name="entranceTime" autocomplete="off" /></td>
	        </tr>
	        <tr>
	          <th>就读学校</th>
	          <td colspan="4"><input type="text" class="input" name="school" /></td>
	          <th colspan="2">毕业时间</th>
	          <td><input type="text" class="input" id="graduationTime" name="graduationTime" autocomplete="off"/></td>
	        </tr>
	        <tr>
	          <th>第一导师</th>
	          <td colspan="4"><input type="text" class="input" name="firstMentor" /></td>
	          <th colspan="2">到中心时间</th>
	          <td><input type="text" class="input" id="centerTime" name="centerTime" autocomplete="off"/></td>
	        </tr>
	        <tr>
	          <th>第二导师</th>
	          <td colspan="4"><input type="text" class="input" name="secondMentor" /></td>
	          <th colspan="2">中心责任导师</th>
	          <td><input type="text" class="input" name="centerMentor" /></td>
	        </tr>
	        <tr>
	          <th>所在课题组</th>
	          <td colspan="4"><input type="text" class="input" name="projectGroup" /></td>
	          <th colspan="2">预计离开时间</th>
	          <td><input type="text" class="input" id="departureTime" name="departureTime" autocomplete="off"/></td>
	        </tr>
	        <tr>
	          <th>课题组负责人</th>
	          <td colspan="4"><input type="text" class="input" name="projectGroupPerson" /></td>
	          <th colspan="2">兴趣爱好</th>
	          <td><input type="text" class="input" name="hobby" /></td>
	        </tr>
	        <tr>
	          <th>身份证号码</th>
	          <td colspan="4"><input type="text" class="input" name="idCard" /></td>
	        ...
	        <tr>
	          ...
	          <th>联系电话</th>
	          <td colspan="2"><input type="text" class="input" name="contactsPhone" /></td>
	          <th>与本人关系</th>
	        ...
	        <tr>
	          ...
	          <th>任过何种职务</th>
	          <td colspan="2"><input type="text" class="input" name="post" /></td>
	          <th>培养方式</th>
